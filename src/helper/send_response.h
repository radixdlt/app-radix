 ...
 * y-coordinate of R).
 *
 * response = G_context.sign_tx_info.signature_len (1) ||
 *            G_context.sign_tx_info.signature (G_context.sign_tx_info.signature_len) ||
 *            G_context.sign_tx_info.v (1)
 *
 * @return zero or positive integer if success, -1 otherwise.
 *
 */
