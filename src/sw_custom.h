...
// Parse ValidatorOwnerCopy (C670-C67F)
#define ERR_CMD_SIGN_TX_VALIDATOR_OWNER_COPY_RESERVED_FAILURE  (ERR_CMD_SIGN_TX + ERR_BYTE_70)
#define ERR_CMD_SIGN_TX_VALIDATOR_OWNER_COPY_VALIDATOR_FAILURE (ERR_CMD_SIGN_TX + ERR_BYTE_71)
#define ERR_CMD_SIGN_TX_VALIDATOR_OWNER_COPY_OWNER_FAILURE     (ERR_CMD_SIGN_TX + ERR_BYTE_72)

// Parse Stake (C680-C68F)
