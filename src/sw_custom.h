...
#define ERR_CMD_SIGN_TX_VALIDATOR_OWNER_COPY_VALIDATOR_FAILURE (ERR_CMD_SIGN_TX + ERR_BYTE_A1)
#define ERR_CMD_SIGN_TX_VALIDATOR_OWNER_COPY_OWNER_FAILURE     (ERR_CMD_SIGN_TX + ERR_BYTE_A2)
