...
// PARSE SUBSTATE ID/VIRTUAL SUBSTATE ID (C620-C62F)
...
#define ERR_CMD_SIGN_TX_INVALID_VIRTUAL_SUBSTATE_ID     (ERR_CMD_SIGN_TX + ERR_BYTE_22)

// PARSE SUBSTATE (C630-C66F)
// =:Parse Substate Common:= (C630-C63F)
...
#define ERR_CMD_SIGN_TX_INVALID_SUBSTATE_FORMAT    (ERR_CMD_SIGN_TX + ERR_BYTE_32)
...
// Parse Tokens (C650-C65F)
#define ERR_CMD_SIGN_TX_TOKENS_PARSE_RESERVED_FAILURE (ERR_CMD_SIGN_TX + ERR_BYTE_50)
#define ERR_CMD_SIGN_TX_TOKENS_PARSE_OWNER_FAILURE    (ERR_CMD_SIGN_TX + ERR_BYTE_51)
#define ERR_CMD_SIGN_TX_TOKENS_PARSE_RESOURCE_FAILURE (ERR_CMD_SIGN_TX + ERR_BYTE_52)
#define ERR_CMD_SIGN_TX_TOKENS_PARSE_AMOUNT_FAILURE   (ERR_CMD_SIGN_TX + ERR_BYTE_53)

// Parse Stake (C660-C66F)
#define ERR_CMD_SIGN_TX_PREPARED_STAKE_PARSE_RESERVED_FAILURE  (ERR_CMD_SIGN_TX + ERR_BYTE_60)
#define ERR_CMD_SIGN_TX_PREPARED_STAKE_PARSE_VALIDATOR_FAILURE (ERR_CMD_SIGN_TX + ERR_BYTE_61)
#define ERR_CMD_SIGN_TX_PREPARED_STAKE_PARSE_OWNER_FAILURE     (ERR_CMD_SIGN_TX + ERR_BYTE_62)
#define ERR_CMD_SIGN_TX_PREPARED_STAKE_PARSE_AMOUNT_FAILURE    (ERR_CMD_SIGN_TX + ERR_BYTE_63)

// Parse StakeOwnership (C670-C67F)
#define ERR_CMD_SIGN_TX_STAKE_OWNERSHIP_PARSE_RESERVED_FAILURE  (ERR_CMD_SIGN_TX + ERR_BYTE_70)
#define ERR_CMD_SIGN_TX_STAKE_OWNERSHIP_PARSE_VALIDATOR_FAILURE (ERR_CMD_SIGN_TX + ERR_BYTE_71)
#define ERR_CMD_SIGN_TX_STAKE_OWNERSHIP_PARSE_OWNER_FAILURE     (ERR_CMD_SIGN_TX + ERR_BYTE_72)
#define ERR_CMD_SIGN_TX_STAKE_OWNERSHIP_PARSE_AMOUNT_FAILURE    (ERR_CMD_SIGN_TX + ERR_BYTE_73)

// Parse Unstake (C680-C68F)
#define ERR_CMD_SIGN_TX_PREPARED_UNSTAKE_PARSE_RESERVED_FAILURE  (ERR_CMD_SIGN_TX + ERR_BYTE_80)
#define ERR_CMD_SIGN_TX_PREPARED_UNSTAKE_PARSE_VALIDATOR_FAILURE (ERR_CMD_SIGN_TX + ERR_BYTE_81)
#define ERR_CMD_SIGN_TX_PREPARED_UNSTAKE_PARSE_OWNER_FAILURE     (ERR_CMD_SIGN_TX + ERR_BYTE_82)
#define ERR_CMD_SIGN_TX_PREPARED_UNSTAKE_PARSE_AMOUNT_FAILURE    (ERR_CMD_SIGN_TX + ERR_BYTE_83)

// Parse ValidatorAllowDelegationFlag (C690-C69F)
#define ERR_CMD_SIGN_TX_VALIDATOR_ALLOW_DELEGATION_FLAG_RESERVED_FAILURE \
    (ERR_CMD_SIGN_TX + ERR_BYTE_90)
#define ERR_CMD_SIGN_TX_VALIDATOR_ALLOW_DELEGATION_FLAG_VALIDATOR_FAILURE \
    (ERR_CMD_SIGN_TX + ERR_BYTE_91)
#define ERR_CMD_SIGN_TX_VALIDATOR_ALLOW_DELEGATION_FLAG_IS_DELEGATION_ALLOWED_FAILURE \
    (ERR_CMD_SIGN_TX + ERR_BYTE_92)

// Parse ValidatorOwnerCopy (C6A0-C6AF)
#define ERR_CMD_SIGN_TX_VALIDATOR_OWNER_COPY_RESERVED_FAILURE (ERR_CMD_SIGN_TX + ERR_BYTE_A0)
#define ERR_CMD_SIGN_TX_VALIDATOR_OWNER_COPY_EPOCH_UPDATE_OPTIONAL_FAILURE \
    (ERR_CMD_SIGN_TX + ERR_BYTE_A1)
#define ERR_CMD_SIGN_TX_VALIDATOR_OWNER_COPY_EPOCH_UPDATE_FAILURE (ERR_CMD_SIGN_TX + ERR_BYTE_A2)
#define ERR_CMD_SIGN_TX_VALIDATOR_OWNER_COPY_VALIDATOR_FAILURE    (ERR_CMD_SIGN_TX + ERR_BYTE_A3)
#define ERR_CMD_SIGN_TX_VALIDATOR_OWNER_COPY_OWNER_FAILURE        (ERR_CMD_SIGN_TX + ERR_BYTE_A4)

// Parse instruction (C6B0 - C6BF)
#define ERR_CMD_SIGN_TX_PARSE_INS_SYSCALL     (ERR_CMD_SIGN_TX + ERR_BYTE_B0)
#define ERR_CMD_SIGN_TX_PARSE_INS_HEADER      (ERR_CMD_SIGN_TX + ERR_BYTE_B1)
#define ERR_CMD_SIGN_TX_PARSE_INS_EXTRA_BYTES (ERR_CMD_SIGN_TX + ERR_BYTE_B2)

// Various exceptions during Sign TX flow (C6E0 - C6EF)
