...
#define ERR_CMD_SIGN_TX_INVALID_CONFIG (ERR_CMD_SIGN_TX + ERR_GEN_ID_07)

#define ERR_CMD_SIGN_TX_UNRECOGNIZED_INSTRUCTION_TYPE  (ERR_CMD_SIGN_TX + ERR_GEN_ID_08)
#define ERR_CMD_SIGN_TX_UNSUPPORTED_INSTRUCTION_TYPE   (ERR_CMD_SIGN_TX + ERR_GEN_ID_09)
#define ERR_CMD_SIGN_TX_FAILED_TO_COMPRESS_MY_KEY      (ERR_CMD_SIGN_TX + ERR_GEN_ID_0A)
#define ERR_CMD_SIGN_TX_PARSE_TX_FEE_FROM_SYSCALL_FAIL (ERR_CMD_SIGN_TX + ERR_GEN_ID_0B)
