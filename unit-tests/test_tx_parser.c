...
static void test_parse_tx(void **state) {
	...
	uint8_t ins5[] = {0x05, 0x00, 0x00, 0x00, 0x03};
	...
	uint8_t tx_instructions[9][255];
	// Uh, please help me fix this TERRIBLE code. Cant seem to get byte matrix right...
	tx_instructions[0][0] = ins0[0];
	tx_instructions[1][0] = ins1[0];
	tx_instructions[2][0] = ins2[0];
	tx_instructions[3][0] = ins3[0];
	tx_instructions[4][0] = ins4[0];
	tx_instructions[5][0] = ins5[0];
	tx_instructions[6][0] = ins6[0];
	tx_instructions[7][0] = ins7[0];
	tx_instructions[8][0] = ins8[0];

	const expected_instruction_t expected_instructions[9] = {
		(expected_instruction_t){
			.byte_count = 3,
